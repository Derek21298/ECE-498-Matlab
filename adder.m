...
% Last Modified by GUIDE v2.5 21-Apr-2020 21:19:44
...
input1 = str2double(hObject.String);
...
input2 = str2double(hObject.String);
...
result = num2str(str2double(input1) + str2double(input2));
